...
numSets         			= 4
rand            			= True # whether to randomize the order of the amplitude in each set
LR_shuffle_stat				= True # shuffle the left and right direction of the stimulus for sets
amp_series                  = np.arange(200, 1700, 200) # intended angular velocity in deg/s
stimV_map_func  			= lambda amp: 2.5 + 0.2 * np.where(amp_series == amp)[0][0] # this is for data analysis, to map the amplitude to the voltage used in the experiment
